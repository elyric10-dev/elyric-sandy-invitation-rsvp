...
export const WeddingQRPass = ({
  ...
  useEffect(() => {
    const fetchInvitationData = async () => {
      try {
        const response = await getPassData(invitationCode);
        const invitationDataResponse = await getInvitationData(invitationCode);
        ...
        <div className="flex flex-col items-center gap-1">
          ...
          <div className="w-full flex flex-col items-center justify-center gap-8 mt-8">
            ...
            <div className="flex flex-col items-center justify-center text-center gap-2 m-8">
              <h2
                className="montaser-arabic !font-semibold text-xl"
                style={{ color: lighterBlack }}
              >
                Need to Update Your RSVP?
              </h2>
              <h2
                className="courgette text-md text-center"
                style={{ color: darkerLilac }}
              >
                We understand plans can change. You can update your response by
                visiting: <br />
                <a
                  href={`https://elyric-sandy.elyricm.cloud/rsvp/${invitationCode}#rsvp-card`}
                  target="_blank"
                  className="text-blue-600 underline"
                >
                  {`https://elyric-sandy.elyricm.cloud/rsvp/${invitationCode}`.slice(
                    0,
                    50
                  )}
                  ...
          ...
          <div className="flex flex-col items-center justify-center gap-8 leading-4">
            <div className="flex flex-col items-center justify-center px-16 text-center">
              ...
              >
                ...
                For your convenience, you may scan the QR code to send your
                gift.
              </h3>
            </div>
